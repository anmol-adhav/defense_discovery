"""
Score neighbor protein clusters by multi-defense-system co-occurrence.
...
MIN_GENOMES = 10        # minimum genomes a cluster must appear in
MIN_SYSTEM_TYPES = 2    # minimum distinct defense system types
# ────────────────────────────────────────────────────────────────────────────────
...
candidates = summary[
    (summary['n_genomes'] >= MIN_GENOMES) &
    (summary['n_system_types'] >= MIN_SYSTEM_TYPES)
